 ...
 * @author almos
 */
public class LeaveRequest1 extends javax.swing.JFrame {
...
private void logTochangeLogTable(String action) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LeaveRequest1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LeaveRequest1().setVisible(true);
            }
        });
    }
