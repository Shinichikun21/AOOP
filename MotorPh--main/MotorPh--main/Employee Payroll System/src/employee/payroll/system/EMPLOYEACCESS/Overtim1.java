...
import employee.payroll.system.EMPLOYEACCESS.*;
 ...
 * @author almos
 */
public class Overtim1 extends javax.swing.JFrame {
...
try {
    ...
    String insertRequestSql = "INSERT INTO Overtime (employee_id, firstname, surname, reason, hours, status, empid) " +
                              "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    pst.setString(6, "Pending"); // Set the status to "Pending" by default
    pst.setString(7, txt_emp.getText()); // Set the status to "Pending" by default
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Overtim1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
