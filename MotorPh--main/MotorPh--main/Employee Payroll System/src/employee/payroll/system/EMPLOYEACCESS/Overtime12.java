 ...
 * @author almos
 */
public class Overtime12 extends javax.swing.JFrame {
...
if (p == 0) {
    try {
        ...
        String sql = "DELETE FROM Overtime WHERE request_id = ?";
        pst = conn.prepareStatement(sql);
        pst.setString(1, txt_id.getText());
        pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Overtime12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Overtime12().setVisible(true);
            }
        });
    }
