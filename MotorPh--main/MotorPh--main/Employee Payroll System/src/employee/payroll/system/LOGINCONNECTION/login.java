...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        cmd_Login.setFont(new Font("Tahoma", Font.BOLD, 11));
	...
	public void cmd_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_LoginActionPerformed
        // TODO add your handling code here:
          ...
          String access=(txt_combo.getSelectedItem().toString());
           ...
           if (access.equals("IT")) {
               ...
               JOptionPane.showMessageDialog(null,"Username and Password is not correct"); 
                   ...
                   else if(access=="Payroll Manager"){
                       
                       if(count ==1){
                       JOptionPane.showMessageDialog(null,"Sucess");
                       MainMenu2 j = new MainMenu2();
                       j.setVisible (true); 
