 ...
 * @author Hyrex
 */
public class changeLog1 extends javax.swing.JFrame {
...
PreparedStatement pst=null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(changeLog1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new changeLog1().setVisible(true);
            }
        });
    }
