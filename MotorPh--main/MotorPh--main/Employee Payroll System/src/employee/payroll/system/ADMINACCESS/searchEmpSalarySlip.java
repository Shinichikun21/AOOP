...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        txt_dep.setBackground(new Color(255, 255, 255));
        jLabel6 = new javax.swing.JLabel();
        txt_id1 = new javax.swing.JTextField();
        txt_id1.setBackground(new Color(255, 255, 255));
        ...
        txt_desig.setBackground(new Color(255, 255, 255));
        ...
        jButton1.setIcon(new ImageIcon(searchEmpSalarySlip.class.getResource("/employee/payroll/system/Images/icons8-load-30.png"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txt_id1, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    try {
        ...
        if (dialogResult == JFileChooser.APPROVE_OPTION) {
            ...
            if (rs.next()) {
                ...
                rs = pst.executeQuery();
                if (rs.next()) {
                    Double calcTotal = Double.parseDouble(rs.getString("salary"));
                    float x = Float.parseFloat(rs.getString("Net"));
                    double v = Double.parseDouble(val);
                    float total = (float) (calcTotal + x - v);

                    // Fetch overtime details
                    String overtimeQuery = "SELECT * FROM Overtime WHERE empid = ?";
                    pst = conn.prepareStatement(overtimeQuery);
                    pst.setString(1, value1);
                    ResultSet overtimeRs = pst.executeQuery();
                    ...
                    myDocument.add(new Paragraph("Basic Salary: P " + calcTotal, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("Deduction Insurance: P " + insurance, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("Deduction Tax: P " + tax, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("Total Deductions: P " + val, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
                    
                    // Add allowance details
                    myDocument.add(new Paragraph("TOTAL PAYMENT", FontFactory.getFont(FontFactory.TIMES_ROMAN, 15, Font.BOLD)));
                    myDocument.add(new Paragraph("Rice Subsidy: P " + rs.getString("Rice"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("Clothing: P " + rs.getString("Clothing"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    ...
                    myDocument.add(new Paragraph("Bonus: P " + rs.getString("Bonus"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("Others: P " + rs.getString("Others"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("Salary Net: P " + rs.getString("Net"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("Salary Gross: P " + total, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                    myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
                    
                    
                 // Add overtime details
                    myDocument.add(new Paragraph("OVERTIME DETAILS", FontFactory.getFont(FontFactory.TIMES_ROMAN, 15, Font.BOLD)));
                    while (overtimeRs.next()) {
                        myDocument.add(new Paragraph("Hours: " + overtimeRs.getString("Hours"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                        
                        // Check for "Percentage" column existence using try-catch
                        try {
                            String percentage = overtimeRs.getString("Percentage");
                            if (percentage != null) {
                                myDocument.add(new Paragraph("Percentage: " + percentage, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                            }
                        } catch (SQLException e) {
                            // Likely "Percentage" column doesn't exist, print N/A
                            myDocument.add(new Paragraph("Percentage: N/A", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                        }
                        
                        try {
                            myDocument.add(new Paragraph("Total Overtime: " + overtimeRs.getString("Total_overtime"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                        } catch (SQLException e) {
                            // Likely "Total_overtime" column doesn't exist, print N/A
                            myDocument.add(new Paragraph("Total Overtime: N/A", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                        }
                        
                        // Handle potential absence of "Salary_overtime"
                        try {
                            String salaryOvertime = overtimeRs.getString("Salary_overtime");
                            if (salaryOvertime != null) {
                                myDocument.add(new Paragraph("Salary Overtime: " + salaryOvertime, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                            } else {
                                myDocument.add(new Paragraph("Salary Overtime: N/A", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                            }
                        } catch (SQLException e) {
                            // Likely "Salary_overtime" column doesn't exist, print N/A (can be removed if the column definitely exists)
                            myDocument.add(new Paragraph("Salary Overtime: N/A", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                        }
	...
	public users getEmployeeInformation(String employeeId) {
