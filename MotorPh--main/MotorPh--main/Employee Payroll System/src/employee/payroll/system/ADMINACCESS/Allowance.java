...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        txt_update.setBackground(Color.WHITE);
        cmd_delete = new javax.swing.JButton();
        cmd_delete.setBackground(Color.WHITE);
        jScrollPane1 = new javax.swing.JScrollPane();
        table_allowance = new javax.swing.JTable();
        table_allowance.setFont(new Font("Tahoma", Font.PLAIN, 10));
        ...
        jLabel10.setFont(new Font("Tahoma", Font.BOLD, 12)); // NOI18N
        jLabel10.setText("NET ALLOWANCE:");
        ...
        jButton1.setIcon(new ImageIcon(Allowance.class.getResource("/employee/payroll/system/Images/icons8-erase-16.png"))); // NOI18N
        		...
        		.addGroup(jPanel2Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.TRAILING)
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					...
        					.addGap(53)
        					.addComponent(txt_others, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					...
        					.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING, false)
        						.addComponent(txt_phone, GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
        			...
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(lbl_total, GroupLayout.PREFERRED_SIZE, 149, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jButton1, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE)
        				.addComponent(txt_cal, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE)
        			...
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.TRAILING)
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					...
        					.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
        						.addComponent(jLabel17)
        						.addComponent(txt_emid, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
        				.addComponent(jLabel10))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jLabel4)
        				.addComponent(t_rice, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				...
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					...
        					.addGroup(jPanel2Layout.createParallelGroup(Alignment.TRAILING)
        						.addGroup(jPanel2Layout.createSequentialGroup()
        							.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
        								.addComponent(jLabel6)
        								.addComponent(t_clothing, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        							.addPreferredGap(ComponentPlacement.UNRELATED)
        							.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
        							...
        							.addGap(12))
        						.addGroup(jPanel2Layout.createSequentialGroup()
        							.addComponent(txt_cal, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
        							.addGap(23)))
        					.addComponent(jLabel11)
        					.addContainerGap(42, Short.MAX_VALUE))
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					.addPreferredGap(ComponentPlacement.RELATED, 77, Short.MAX_VALUE)
        					.addComponent(txt_bonus, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        						.addComponent(jButton1, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
        						.addComponent(txt_others, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        					.addContainerGap())))
        );
        jPanel2.setLayout(jPanel2Layout);

        jButton2.setIcon(new ImageIcon(Allowance.class.getResource("/employee/payroll/system/Images/icons8-save-16.png"))); // NOI18N
        ...
        txt_update.setIcon(new ImageIcon(Allowance.class.getResource("/employee/payroll/system/Images/icons8-update-16.png"))); // NOI18N
        ...
        cmd_delete.setIcon(new ImageIcon(Allowance.class.getResource("/employee/payroll/system/Images/icons8-delete-16.png"))); // NOI18N
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jPanel4, GroupLayout.DEFAULT_SIZE, 701, Short.MAX_VALUE)
        					.addContainerGap())
        				.addGroup(layout.createSequentialGroup()
        					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        						.addGroup(layout.createSequentialGroup()
        							...
        							.addPreferredGap(ComponentPlacement.UNRELATED)
        							.addComponent(jPanel2, GroupLayout.PREFERRED_SIZE, 385, GroupLayout.PREFERRED_SIZE))
        						.addGroup(layout.createSequentialGroup()
        							.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 569, Short.MAX_VALUE)
        							.addPreferredGap(ComponentPlacement.UNRELATED)
        							.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
        								.addComponent(cmd_delete, 0, 0, Short.MAX_VALUE)
        								.addComponent(jButton2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        								.addComponent(txt_update, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))
        							.addGap(11)))
        					.addContainerGap())
        				.addGroup(layout.createSequentialGroup()
        	...
        	layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(txt_update, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(jButton2, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.UNRELATED)
        					.addComponent(cmd_delete, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
        					.addContainerGap())))
        );
